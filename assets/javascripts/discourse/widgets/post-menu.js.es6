...
registerButton('like-count', (attrs, state) => {
...
export default createWidget('post-menu', {
  ...
  html(attrs, state) {
    ...
    postControls.push(h('div.actions', [h('div.left', visibleButtons), h('div.right', visibleButtonsRightSide)]));
